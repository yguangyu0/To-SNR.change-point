###########################################################################################
########### Simulation Codes For Logistic Segmented Model With Two Change Points ##########
###########################################################################################
...
for (nn in 1:length.nlst)
{
  ...
  while (o < Nsim)
  {
    ...
    ### estimated change points via Muggeo Method (segmented package) ###
